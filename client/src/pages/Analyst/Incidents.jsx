...
const AnalystIncidents = () => {
    ...
    const filtered = incidents.filter(i =>
        ...
        (
            !searchTerm ||
            [i.title, i.description, i.severity, i.status, i.category, i.affectedSystem]
                .filter(Boolean)
                .join(' ')
                .toLowerCase()
            ...
            <div className="main-content">
                ...
                <div className="incidents-content">
                    <div className="incidents-header-row">
                        ...
                        {user?.role !== 'Viewer' && user?.role !== 'Incident Responder' && (
                    ...
                    <div className="filters-bar">
                        <div className="search-container">
                            ...
                            <input
                                ...
                                placeholder="search incidents, IDs, systems..."
                                value={searchTerm}
                        ...
                        <table className="incidents-table">
                            ...
                            <tbody>
                                {paginatedIncidents.map((inc) => {
                                    ...
                                    return (
                                        <tr key={inc._id || inc.id} onClick={() => setViewIncidentId(inc._id)}>
                                            ...
                                            <td style={{ color: '#94a3b8' }}>{inc.category || 'N/A'}</td>
                                            <td style={{ fontFamily: 'monospace', fontSize: '11px', color: '#94a3b8' }}>{inc.affectedSystem || 'system-unknown'}</td>
                                            <td style={{ color: '#e2e8f0' }}>{inc.assignedTo?.name || 'Unassigned'}</td>
                                ...
                                {filtered.length === 0 && (
                                    <tr>
                                        <td colSpan="9" style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>No incidents found matching criteria</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
